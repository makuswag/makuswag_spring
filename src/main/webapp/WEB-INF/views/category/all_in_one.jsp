        ...
        <div class="product-tiles">
            <c:forEach items="${list}" var="dto">
                <div class="tile xans-record-">
                    <a href="bbb.jsp?productId=${dto.proName}">  
                        <div class="product-image">
                            <img src="${pageContext.request.contextPath}/images/${dto.proImage1}" class="primary-image" alt="${dto.proName}">
                            <img src="${pageContext.request.contextPath}/images/${dto.proImage2}" class="secondary-image" alt="${dto.proName}">
                        </div>
