						...
						<div class="xans-element- xans-board xans-board-read ">
							...
							<div class="post-content">
											<div class="content">
												...
												<div><img src="${pageContext.request.contextPath}/images/board/${content_view.noImage}" alt="" width="100" height="100" style="${content_view.noImage != null ? '' : 'display: none;'}"></div>
											</div>
										</div>
